...
export default function Battery() {
  ...
  return (
    <section
      ref={sectionRef}
      id="battery"
      className="w-full bg-[#f9f9f9] px-8 lg:px-16 py-20 relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="flex flex-col gap-8 max-w-md w-full">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div
              data-card
              style={{ clipPath: "inset(0 0 100% 0)", background: "transparent" }}
              className="rounded-2xl px-5 py-5 flex items-center gap-4 border border-black/15 hover:border-black/40 transition-all duration-50 cursor-default"
            >
        ...
        <div className="flex flex-col items-center lg:items-end gap-8">
          <div data-case-img style={{ opacity: 0 }}>
            <Image
